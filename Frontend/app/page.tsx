  ...
  return (
    <>
      ...
      <div className="relative w-full min-h-screen flex flex-col overflow-y-auto">
        {/* Hero Section */}
        <section className="bg-gradient-to-b from-black via-gray-900 to-black py-8 sm:py-12 lg:py-16 px-4">
              ...
              <div className="grid lg:grid-cols-2 gap-6 lg:gap-10 xl:gap-12 items-start">
                ...
                <div className="space-y-4 sm:space-y-6 text-white order-2 lg:order-1">
                  ...
                  <div className="space-y-4 sm:space-y-6">
                    <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-3 sm:p-4 hover:bg-white/15 transition-all duration-300 transform hover:scale-[1.02] shadow-xl">
                      <div className="flex items-start gap-3">
                        <div className="flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br from-cyan-500 to-blue-600 flex items-center justify-center shadow-lg">
                        ...
                        <div className="flex-1">
                          <h3 className="text-lg sm:text-xl font-bold mb-1 text-white">Sui World News</h3>
                          <p className="text-sm sm:text-base text-white/95 leading-relaxed">Access real-time updates and in-depth articles covering major developments across the Sui network and its partners</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-3 sm:p-4 hover:bg-white/15 transition-all duration-300 transform hover:scale-[1.02] shadow-xl">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          <h3 className="text-lg sm:text-xl font-bold mb-1 text-white">Live Metrics & Analytics</h3>
                          <p className="text-sm sm:text-base text-white/95 leading-relaxed">Track real-time TVL, token prices, network statistics, and gas fee analytics for informed decision-making</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-3 sm:p-4 hover:bg-white/15 transition-all duration-300 transform hover:scale-[1.02] shadow-xl">
                      <div className="flex items-start gap-3">
                        <div className="flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br from-teal-500 to-green-600 flex items-center justify-center shadow-lg">
                          <svg className="w-5 h-5 sm:w-6 sm:h-6 text-white" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                          </svg>
                        </div>
                        <div className="flex-1">
                          <h3 className="text-lg sm:text-xl font-bold mb-1 text-white">Community & Social Feed</h3>
                          <p className="text-sm sm:text-base text-white/95 leading-relaxed">Connect with the Sui community through official announcements, developer updates, and trending discussions</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="pt-6 sm:pt-8">
                    <div className="bg-gradient-to-r from-cyan-500/20 to-blue-500/20 border border-cyan-500/30 rounded-2xl p-6 backdrop-blur-sm">
                      <div className="text-center">
                        <h4 className="text-lg sm:text-xl font-bold text-white mb-2">Ready to Get Started?</h4>
                        <p className="text-sm sm:text-base text-white/80 mb-4">New to Sui? Create your Slush wallet and join thousands of users in the ecosystem.</p>
                        <button className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white font-semibold py-3 px-6 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg">
                          Create Wallet Now
                        </button>
                      </div>
                    </div>
