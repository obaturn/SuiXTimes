  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 text-gray-900">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(236,72,153,0.05),transparent_80%)]" />
        ...
        <div className="relative z-10 container mx-auto text-center max-w-5xl px-4 py-20">
          ...
          >
            ...
            >
              <Button
                size="lg"
                className="bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white px-10 py-5 text-xl font-semibold rounded-2xl shadow-2xl shadow-blue-500/25 transform hover:scale-105 transition-all duration-300 border border-blue-400/50"
              >
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-2 border-gray-300 text-gray-700 hover:bg-gray-50 px-10 py-5 text-xl font-semibold rounded-2xl backdrop-blur-sm bg-white/10 hover:bg-white/20 transition-all duration-300 transform hover:scale-105"
              >
        ...
        <div className="container mx-auto px-4 relative">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Community <span className="text-blue-600">Statistics</span>
            </h2>
      ...
      <section className="py-20 bg-gradient-to-b from-background via-muted/30 to-background relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Discussion <span className="text-blue-600">Forums</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
      ...
      <section className="py-20 bg-gradient-to-b from-background via-muted/20 to-background relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Featured <span className="text-blue-600">Discussions</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
        ...
        <div className="container mx-auto px-4 relative">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {guidelines.map((guideline, index) => (
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-gradient-to-r from-blue-500 to-purple-500 flex items-center justify-center">
      ...
      <section className="py-32 bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_60%,rgba(59,130,246,0.2),transparent_70%)]" />
